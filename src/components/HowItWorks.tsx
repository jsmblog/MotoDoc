    ...
    <section id="como-funciona" className="how">
      <div className="container">
        <div className="how__header">
          <span className="section-label">Sin complicaciones</span>
          <h2 className="section-title">Así de fácil funciona</h2>
        </div>
        ...
        <a
          href="https://wa.me/593999999999?text=Hola,%20quiero%20agendar%20un%20servicio"
          className="btn-primary how__action"
          target="_blank"
          rel="noreferrer"
        >
